defmodule PonbotWeb.UserControllerTest do
  use PonbotWeb.ConnCase

  alias Ponbot.Accounts

  @create_attrs %{last_login: ~T[14:00:00], line_id: "some line_id", username: "some username"}
  ...
  describe "update user" do
    ...
    test "redirects when data is valid", %{conn: conn, user: user} do
      ...
      assert html_response(conn, 200) =~ "some updated line_id"
    end

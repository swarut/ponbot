defmodule PonbotWeb.AddressControllerTest do
  use PonbotWeb.ConnCase

  alias Ponbot.Accounts

  @create_attrs %{city: "some city", country: "some country", postcode: "some postcode", state: "some state", street_address: "some street_address"}
